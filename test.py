...
def next_turn(row, column):
    ...
    global joueur, liste_cases_vides
    liste_cases_vides = [(row, column) for row in range(3) for column in range(3) if boutons[row][column]['text'] == "" and check_winner is False]
